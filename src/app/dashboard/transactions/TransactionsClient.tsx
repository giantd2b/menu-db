...
import { ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight, X, Split, Pencil, ArrowLeft } from 'lucide-react'
...
import SplitTransactionDialog from '@/components/dashboard/SplitTransactionDialog'
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold">จัดการ Transactions</h1>
            <p className="text-muted-foreground">แก้ไข, ลบ, หรือแบ่งรายการ</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2">
          ...
          <Select value={selectedCategory} onValueChange={setSelectedCategory}>
            ...
            <SelectContent>
              ...
              <SelectItem value="uncategorized">ยังไม่จัดหมวดหมู่</SelectItem>
      ...
      <Card>
        <CardHeader>
          <CardTitle>รายการทั้งหมด ({total} รายการ)</CardTitle>
        </CardHeader>
        <CardContent>
          {/* Bulk Action Bar */}
          {isSomeSelected && (
